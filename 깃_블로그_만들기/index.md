...
<div style="height: 10px;"></div>
<details>
    <summary style="color: deepskyblue">에러 로그</summary>
    <div style="border-radius: 20px; padding: 5px 30px;background-color: rgba(98,92,92,0.3);">
...
<details>
    <summary style="color: deepskyblue">PC 이미지</summary>
    <img style="width: 500px;" src="/img/posts/blog/createdGitBlog/pc.png">
</details>
<details>
    <summary style="color: deepskyblue">mobile 이미지</summary>
...
<details>
    <summary style="color: deepskyblue">블로그 주소 확인하기</summary>
    <p>
        블로그 주소를 모르겠다면<br>
